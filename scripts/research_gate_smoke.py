...
with tempfile.TemporaryDirectory() as tmp:
    ...
    code, msg = gate({"hook_event_name":"PreToolUse","session_id":"s1","tool_name":"Write","tool_input":{"file_path":"scene.js"}}); assert code == 2 and "research required once" in msg.lower()
    ...
    code, _ = gate({"hook_event_name":"PostToolUse","session_id":"s2","tool_name":"FetchURL","tool_output":"network error: failed to fetch"}); assert code == 0
    code, _ = gate({"hook_event_name":"PreToolUse","session_id":"s2","tool_name":"Edit","tool_input":{"file_path":"index.html"}}); assert code == 0
